...
class EmailScraper:
    ...
    ## OK  
    """"def scrape_email_content_old(self):
        try:
            body = None
...
#         'parts': [{
#             'body': {
#                 'data': 'wqzU5R... (base64 encoded email content)'
#             }
#         }]
#     }
# }
...
# scraper = EmailScraper(email_message)

# # Scrape email content
# email_text = scraper.scrape_email_content()

# # Check if scraping was successful
# if email_text:
#     # Extract the data
#     extracted_data = scraper.query_emails(email_text)

#     # Save the data to a JSON file
#     scraper.save_to_json(extracted_data)
